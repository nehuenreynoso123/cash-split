...
import { toRaw, toDisplay } from '../../lib/numFormat';
...
type TabId = 'usdt-ars' | 'porcentaje-costo' | 'ganancia' | 'costo-usdt';

const TABS: { id: TabId; label: string; icon: string }[] = [
  { id: 'usdt-ars', label: 'USDT → ARS', icon: 'currency_exchange' },
  { id: 'porcentaje-costo', label: '% del Costo', icon: 'percent' },
  { id: 'ganancia', label: '% Ganancia', icon: 'trending_up' },
  { id: 'costo-usdt', label: 'Costo USDT', icon: 'conversion_path' },
];
...
export default function CalculadoraClient() {
  ...
  // Tab activo de la card de calculadoras
  const [tabActivo, setTabActivo] = useState<TabId>('usdt-ars');
