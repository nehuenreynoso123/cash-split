...
| --- | --- | --- | --- |
| `sdd-explore` | Explore SDD ideas before committing to a change. | sdd | `C:\Users\user\.config\opencode\skills\sdd-explore\SKILL.md` |
| `sdd-propose` | Create an SDD change proposal with intent, scope, and approach. | sdd | `C:\Users\user\.config\opencode\skills\sdd-propose\SKILL.md` |
| `sdd-spec` | Write SDD delta specs with requirements and scenarios. | sdd | `C:\Users\user\.config\opencode\skills\sdd-spec\SKILL.md` |
| `sdd-design` | Create the SDD technical design and architecture approach. | sdd | `C:\Users\user\.config\opencode\skills\sdd-design\SKILL.md` |
| `sdd-tasks` | Break an SDD change into implementation tasks. | sdd | `C:\Users\user\.config\opencode\skills\sdd-tasks\SKILL.md` |
| `sdd-apply` | Implement SDD tasks from specs and design. | sdd | `C:\Users\user\.config\opencode\skills\sdd-apply\SKILL.md` |
| `sdd-verify` | Execute tests and prove implementation matches specs, design, and tasks. | sdd | `C:\Users\user\.config\opencode\skills\sdd-verify\SKILL.md` |
| `sdd-archive` | Archive a completed SDD change by syncing delta specs. | sdd | `C:\Users\user\.config\opencode\skills\sdd-archive\SKILL.md` |
| `sdd-onboard` | Walk users through the SDD workflow on the real codebase. | sdd | `C:\Users\user\.config\opencode\skills\sdd-onboard\SKILL.md` |
| `sdd-init` | Initialize SDD context, testing capabilities, registry, and persistence. | sdd | `C:\Users\user\.config\opencode\skills\sdd-init\SKILL.md` |
...
| `go-testing` | Apply focused Go testing patterns. | user | `C:\Users\user\.config\opencode\skills\go-testing\SKILL.md` |
...
| `skill-registry` | Index available skills by trigger and path. | user | `C:\Users\user\.config\opencode\skills\skill-registry\SKILL.md` |
